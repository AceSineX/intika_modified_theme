...
PROMPT='%{$fg[green]%}[%{$fg[magenta]%}%T%{$fg[green]%}][%{$fg[cyan]%}%n%{$fg[magenta]%}@%{$fg[cyan]%}%m%{$fg[green]%}:%{$fg[magenta]%}%c%{$reset_color%}%{$fg[gray]%}$(git_prompt_info)%{$fg[green]%}]$(prompt_char)%{$reset_color%} '
